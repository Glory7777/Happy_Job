...
public class DeliveryModel {
	...
	private int pro_sup_price;
	private int pro_unit_price;
	...
	public void setCt_cd(String ct_cd) {
		this.ct_cd = ct_cd;
	}
	...
	public int getPro_sup_price() {
		return pro_sup_price;
	}
	public void setPro_sup_price(int pro_sup_price) {
		this.pro_sup_price = pro_sup_price;
	}
	public int getPro_unit_price() {
		return pro_unit_price;
	}
	public void setPro_unit_price(int pro_unit_price) {
