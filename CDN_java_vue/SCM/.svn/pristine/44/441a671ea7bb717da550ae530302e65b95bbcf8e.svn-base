...
public class PurchaseApprovalModel {
	...
	public String getPro_sup_price() {
		return pro_sup_price;
	}
	public void setPro_sup_price(String pro_sup_price) {
		this.pro_sup_price = pro_sup_price;
	}
	...
	public String getPur_nm() {
		return pur_nm;
	}
	public void setPur_nm(String pur_nm) {
		this.pur_nm = pur_nm;
	}
