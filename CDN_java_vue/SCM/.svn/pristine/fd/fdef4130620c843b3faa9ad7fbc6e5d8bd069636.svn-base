        	...
        	if(data.file_nm == "" || data.file_nm == null) {
        		inserhtml = "";
        		    ...
        		    inserhtml = "<a href='javascript:fn_download()'> "
           	         ...
           	         if(file_extention.toLowerCase() == "jpg" ||  file_extention.toLowerCase() == "png"  ||  file_extention.toLowerCase() == "gif" ||  file_extention.toLowerCase() == "jpeg" ) {
				...
				<li class="contents">
					...
					<div class="content">
						...
						<p class="conTitle">
							<span>공지사항</span> 
							<span class="fr"> 
							    <select id="searchdel" name="searchdel" style="width:100px;">
							    </select>		
							    ...
							    <a class="btnType blue" href="javascript:fn_openpopupfile();" name="modal"><span>신규등록</span></a>
							</span>
						</p>
		...
		<dl>
			...
			<dd class="content">
				...
				<div class="btn_areaC mt30">
					<a href="" class="btnType blue" id="btnSavefile" name="btn"><span id="saveNotice">저장</span><span id="updateNotice">수정</span></a>					
