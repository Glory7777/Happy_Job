...
/////////////////////////sep scm 공지사항///////////////////////
   ...
   function fn_popupintfile(data) {
       	...
       	// 
       	$("#filepreviewDash").empty().append(inserhtml);
					...
					<div class="content" style="margin-bottom:20px;">
						...
						<c:choose>
	    					...
	    					<c:when test="${sessionScope.userType eq 'C'}">
								<jsp:include
								page="/WEB-INF/view/dashboard/dashboardCus.jsp"></jsp:include>
	    					</c:when>
				...
				<table class="row">
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">
							      <input type="text" class="inputTxt p100" name="notice_titlefile" id="notice_titlefile" readonly/>
							 </td>
						</tr>
						<tr>
							<th scope="row">공지내용 <span class="font_red">*</span></th>
							<td colspan="3">
							     <textarea name="notice_contentfile" id="notice_contentfile"  rows="5" cols="30" readonly ></textarea>
						    </td>
						</tr>
						<tr>
