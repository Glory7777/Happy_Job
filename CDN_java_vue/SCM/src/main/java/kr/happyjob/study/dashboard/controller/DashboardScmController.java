...
public class DashboardScmController {
	 ...
	 */
	@ResponseBody
	@RequestMapping("datavue")
	public Map<String, Object> vueGetChartData(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".vueGetChartData");
		...
		logger.info("   - returnmap : " + returnmap);
		logger.info("+ End " + className + ".vueGetChartData");
	 ...
	 */
	@ResponseBody
	@RequestMapping("chartvue")
	public Map<String, Object>  vueListUndata(Model model, @RequestParam Map<String, Object> paramMap, HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		
		logger.info("+ Start " + className + ".vueListUndata");
		...
		logger.info("   - getTotalOrderList : " + getTotalOrderList);
		logger.info("   - getTotalRefundList : " + getTotalRefundList);
		logger.info("+ End " + className + ".vueListUndata");
