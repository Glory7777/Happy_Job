...
public class ScmOrderModel {
	...
	public String getOrder_pur() {
		return order_pur;
	}
	public void setOrder_pur(String order_pur) {
		this.order_pur = order_pur;
	}
