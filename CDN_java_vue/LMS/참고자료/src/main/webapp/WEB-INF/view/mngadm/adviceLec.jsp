...
<script type="text/javascript">
	...
	// 학생 목록 조회
	function fn_findLecList(currentPage, lec_cd, lec_nm) {
	...
	function fn_StdListSet(data, currentPage){
			...
			var listcallback = function(returndata) {
				...
				$("#advStuList").empty().append(returndata);
				
				var advTotalcnt = $("#advTotalcnt").val();
				
				console.log("lec_cd11 ::::" + lec_cd);
				
				var paginationHtml = getPaginationHtml(stuCurrentPage, advTotalcnt, advPageSize, stuPageBlockSize, 'fn_StdListSet', lec_cd);
				console.log("paginationHtml : " + paginationHtml);
				//swal(paginationHtml);
			...
			callAjax("/adm/advStuList.do", "post", "text", true, param, listcallback);
		}
					...
					<p class="conTitle">
							...
							<span class="fr"> 	
							    <select id="searchSel" name="searchSel">
							         ...
							         <option value="lecNm">수강강의</option>
							         <option value="useNm">학생 명</option>
							    </select>
